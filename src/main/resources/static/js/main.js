		...
		$.ajax({
			...
			for (file of data) {
				fileHTML += '<li class="list-group-item"><img src="' + file.thumbnailLink + '">'
					+ file.name
					+ '<button class="btn btn-sm btn-danger" onclick="deleteFile(\'' + file.id + '\')">Delete</button></li>';
			}
...
function deleteFile(id) {
	$.ajax({
		...
		swal("Success!", 'File has been deleted. Please refresh the list.', "success");
	});
}
